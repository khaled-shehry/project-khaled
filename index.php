...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto">
      <img src="images/caas.png" alt="">
      <h2 class="display-4 fw-normal"> سحب على جوائز</h2>
...
<ul class="list-group list-group-flush">
  ...
  <li class="list-group-item">خلال فترة الساعة سيتم فتح صفحة التسجيل هنا حيث ستقوم بتسجيل اسمك وبريدك الإلكتروني</li>
